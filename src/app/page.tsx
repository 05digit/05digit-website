...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-[#f5f5f5] font-mono selection:bg-[#ff003c] selection:text-[#050505] overflow-x-hidden">
      ...
      {/* --- HEADER --- */}
      <header className="sticky top-0 z-40 bg-[#050505] border-b border-[#160a0b] px-4 md:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        {/* Left Status Label */}
        ...
        <div className="flex justify-center items-center sm:w-2/4 flex-col">
          ...
          <span className="inline-block text-3xl md:text-4xl font-normal text-[#f5f5f5] font-sidewalk tracking-widest lowercase cursor-pointer transition-colors duration-300 hover:text-[#ff003c] antialiased" style={{WebkitFontSmoothing: 'antialiased'}}>
            digit
          </span>
        </div>
